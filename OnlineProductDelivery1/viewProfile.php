                ...
                <div class="user-info">
                    ...
                    <form action="partials/_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                        <div class="upload-btn-wrapper">
                            ...
                            <button class="btn upload">Выбр</button>
                            <input type="file" name="image" id="image" accept="image/*">
                        </div>
                        <button type="submit" name="updateProfilePic" class="btn btn-primary" style="margin-top: -20px;font-size: 15px;padding: 3px 8px;">Обнов</button>
                ...
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="Почта" required value="<?php echo $email ?>">
                        </div>
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                            ...
                            <div class="form-group  col-md-6">
                                ...
                                <input class="form-control" id="password" name="password" placeholder="Введите Свой пароль" type="password" required minlength="4" maxlength="21" data-toggle="password">
                            </div>
                        </div>
                        <button type="submit" name="updateProfileDetail" class="btn btn-primary">Обновить</button>
                         <!--<button type="submit" name="updateProfilePic" class="btn btn-primary" style="margin-top: 0px;">Обновить</button> -->
                    </form>
                </div>
            </div>
        </div>
