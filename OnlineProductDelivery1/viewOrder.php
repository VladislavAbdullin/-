...
<body>
    ...
    <div class="container">
        <div class="table-wrapper" id="empty" style="background-color: #c0cdb2;">
            <div class="table-title" style="background-color: #ca6c6e;">
                <div class="row" >
                    <div class="col-sm-4" >
                        <h2>Информация <b>о заказах</b></h2>
                    </div>
                    <div class="col-sm-8">						
            ...
            <table class="table table-striped table-hover text-center" style="background-color: #ca6c6e;">
                <thead>
                    <tr>
                        <th>Номер заказа</th>
                        <th>Адресс</th>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Проверьте свой заказ. Вам нужно <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal">Login</a></strong></center></font>
        </div></div>';
    }
    ?>
