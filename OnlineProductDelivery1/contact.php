...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/Screenshot_1.png);height: 400px;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Введите Свой Адрес Электронной Почты" required value="<?php echo $email ?>">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              <b><label for="orderId">Код заказа:</label></b>
                              <input class="form-control" type="text" id="orderId" name="orderId" placeholder="Код заказа" value="0">
                              <small id="orderIdHelp" class="form-text text-muted">Если ваша проблема не связана с заказом (идентификатор заказа = 0).</small>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              <b><label for="password">Пароль:</label></b>
                              <input class="form-control" id="password" name="password" placeholder="Enter Password" type="password" placeholder="Введите Свой Пароль" required data-toggle="password">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Чем Мы Можем Вам Помочь ?"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> Войти <i class="ti-arrow-right"></i></span></button>
                              <button type="button" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3 mx-2" data-toggle="modal" data-target="#history"><span>Истрория<i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3" disabled><span> Войти<i class="ti-arrow-right"></i></span></button>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/6a7.jpg)">
                          <div class="detail-box p-4">
                            <h5 class="text-white font-weight-light mb-3">Адресс</h5>
                            <p class="text-white op-7">' .$address. '</p>
                            <h5 class="text-white font-weight-light mb-3 mt-4">Связаться с нами</h5>
