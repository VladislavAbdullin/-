...
echo '<nav class="navbar navbar-expand-lg navbar-dark" style="background: #7fd0be;"> 
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="viewOrder.php">Твои заказы</a>
          </li>
        ...
        <form method="get" action="/OnlineProductDelivery/search.php" class="form-inline my-2 my-lg-0 mx-3">
        ...
        echo '<a href="viewCart.php"><button type="button" class="btn btn-secondary mx-2" style="background: #e9d9ae" title="MyCart">
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="btn btn-success mx-2" style="background: #72a594"; border-color: #72a594; data-toggle="modal" data-target="#loginModal">Войти</button>
          <button type="button"  class="btn btn-success mx-2" style="background: #72a594"; border-color: #72a594;  data-toggle="modal" data-target="#signupModal">Зарегистрироваться</button>';
        }
  ...
  echo '</div>
    ...
    if(isset($_GET['signupsuccess']) && $_GET['signupsuccess']=="true") {
      echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Success!</strong> Теперь вы можете войти в систему.
              <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
            </div>';
    }
    if(isset($_GET['error']) && $_GET['signupsuccess']=="false") {
      echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong>Внимание!</strong> ' .$_GET['error']. '
              <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
            </div>';
    }
    if(isset($_GET['loginsuccess']) && $_GET['loginsuccess']=="true"){
      echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Успешно!</strong>Вы вошли в систему
              <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
            </div>';
    }
    ...
    if(isset($_GET['loginsuccess']) && $_GET['loginsuccess']=="false"){
      echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong>Внимание!</strong> Invalid Credentials
              <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
            </div>';
    }
?>
